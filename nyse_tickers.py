"""Lista spolek NYSE (New York Stock Exchange, glowny parkiet) w formacie
Yahoo Finance.

Wygenerowano automatycznie z katalogu otherlisted.txt (nasdaqtrader.com),
Exchange=='N'. Bez instrumentow testowych, warrantow/jednostek/praw
(sufiksy .W/.U/.R) i akcji uprzywilejowanych (tickery z $ - depositary
preferred shares) - zadne z nich nie ma wlasnych fundamentow do liczenia
Wyniku Fishera. Klasy akcji znormalizowane do formatu Yahoo: kropka ->
myslnik (BRK.B w zrodle -> BRK-B, tak jak oczekuje yfinance). 2026-07-20.
"""
...
NYSE_TICKERS = {
    ...
    "MEGI": "NYLI CBRE Global Infrastructure Megatrends Term Fund Common Shares",
    ...
    "MMD": "NYLI MacKay DefinedTerm Muni Opportunities Fund Common Shares",
    ...
    "NE-A": "Noble Corporation plc Tranche 2 Warrants",
